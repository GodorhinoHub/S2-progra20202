...
public class ProfeForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Identificado como Profesor");

        jLabel2.setText("NombreUsuario");

        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "*Seleccione lo que necesite hacer*", "Consultar el estado operativo de los equipos", "Consultar todos los equipos" }));
